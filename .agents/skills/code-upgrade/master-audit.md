...
In both modes, sub-agents research aggressively. Instruct sub-agents to return their findings in a strict markdown structure to ensure seamless merging. Don't re-explain the audits to them.
...
In Deep mode, explicitly flag **cross-boundary issues** (e.g. frontend expects one data shape, backend sends another, or constants duplicated across parts) - those are usually high-impact.
...
Also assign an **Effort/Risk score (Low/Med/High)** to each finding. A high-impact fix that requires days of refactoring (High Risk) is fundamentally different from a high-impact 5-minute fix (Low Risk). 

Aim for a minimal, surgical plan: the biggest impact with the smallest, safest code change. Sort findings by highest impact and lowest effort/risk first.
...
- [ ] **[Action headline]:** [one short sentence on the business value / why it matters (e.g. "Prevents silent cart failures")]
- [ ] **[Action headline]:** [one short sentence on the business value / why it matters]
- [ ] **[Action headline]:** [one short sentence on the business value / why it matters]
...
- **Impact:** [1-10] | **Effort/Risk:** [Low/Med/High]
...
- Score each finding by impact 1-10 and effort Low/Med/High. Sort highest impact and lowest risk first.
